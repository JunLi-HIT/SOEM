...
uint32 get_input_uint32(uint16 slave_no,uint8 module_index)
{
   uint32 return_value;
   uint8 *data_ptr;
...
//                        printf("wkc = %d\n", wkc);
                ...
                osal_time_diff(&tstart, &tend, &tdiff);

                printf("time elapsed sec  = %d\n", tdiff.sec);
                printf("time elapsed usec = %d\n", tdiff.usec);
                printf("time elapsed all  = %f\n", tdiff.sec + tdiff.usec * 0.000001);
...
//                printf("OK : all slaves resumed OPERATIONAL.\n");
                set_output_bit(1, 1, 1);
//                set_output_bit(2, 5, 1);
                osal_usleep(500000);

                set_output_bit(1, 1, 0);
//                set_output_bit(2, 5, 0);
                osal_usleep(500000);
            }
        }
        osal_usleep(10000);
